...
@Component({
  ...
  template: `<div suiTableCell [suiActive]="true"></div>`
})
class TestHostComponent {}

describe('SuiTableCellDirective', () => {
  ...
  beforeEach(async () => {
    ...
    el = fixture.debugElement.query(By.directive(SuiTableCellDirective)).nativeElement;
  });
