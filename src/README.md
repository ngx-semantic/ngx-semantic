...
Components and directives are standalone; import feature `*Module` classes or individual directive/component classes from the published secondary entry points (see the repository README).
