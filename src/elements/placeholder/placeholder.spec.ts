...
describe('SuiPlaceholderComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CommonModule, TestPlaceholderComponent, SuiPlaceholderDirective],
    })
      .compileComponents();
  });
  ...
  beforeEach(() => {
    ...
    placeholderElement = fixture.debugElement.query(By.directive(SuiPlaceholderDirective)).nativeElement;
  });
...
@Component({
  standalone: true,
  imports: [SuiPlaceholderDirective],
  template: `
    <div sui-placeholder
         [suiActive]="suiActive"
         [suiFluid]="suiFluid"
